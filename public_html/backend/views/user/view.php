        ...
        'attributes' => [
            ...
            [
                ...
                'value' => function ($data) {
                    ...
                    return number_format((int) $data->credit) . "<br> مانده زنده:" . number_format($sum_ * -1) . "<br>جمع مانده:" . number_format((int) ($sum_ * -1) + $data->credit);
                    //if ($data->credit)
            ...
            [
                ...
                'value' => function ($data) {
                    ...
                    return number_format((int) $data->credit_naghdi) . "<br> مانده زنده:" . number_format($sum_ * -1) . "<br>جمع مانده:" . number_format((int) ($sum_ * -1) + $data->credit_naghdi);
                }
            ],
            [
                ...
                'format' => 'raw',
                'value' => function ($data) {
                    $sum_ = common\models\Transition::get_live_balance($data->id, 3);

                    return " مانده زنده:" . number_format($sum_ * -1);
                }
            ],
            [
            ...
            [
                ...
                'value' => function ($data) {
                    ...
                    return " مانده سر جمع زنده:" . number_format(($sum_ * -1) + $data->wallet + $data->credit + $data->credit_naghdi);
                }
            ],
        ],
    ])
